 ...
 * @package App\Models
 */
class CommissionsTechnique extends Model
{
	use SoftDeletes;
	protected $table = 'commissions_techniques';
	...
	{
		return $this->hasMany(Offre::class, 'commissions_techniques_id');
	}
}
