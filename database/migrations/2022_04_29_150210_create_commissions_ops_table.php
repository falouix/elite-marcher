...
class CreateCommissionsOpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('commissions_ops', function (Blueprint $table) {
            ...
            $table->bigInteger('dossiers_achats_id')->unsigned()->index('fk_commissions_ops_dossiers_achats1_idx');
    ...
    {
        Schema::dropIfExists('commissions_ops');
    }
}
