...
');
            ...
            $table->bigInteger('commissions_ops_id')->index('fk_offres_commissions_ops1_idx');
            $table->string('decision_technique', 45)->nullable();
            $table->bigInteger('commissions_techniques_id')->index('fk_offres_commissions_techniques1_idx');
            $table->timestamps();
            $table->softDeletes();
