...
class CreateDossiersAchatsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dossiers_achats', function (Blueprint $table) {
            ...
            $table->string('annee_gestion', 4)->default('0');
            $table->string('code_projet', 50)->nullable();
            ...
            $table->enum('type_dossier', ['CONSULTATION', 'AOS', 'AON', 'AOGREGRE'])->nullable()->comment('0 : Consultation\n1 : Appel Offre(إجراءات مبسطو . عادية. تفاوض مباشر)');
