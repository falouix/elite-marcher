...
$(document).ready(function () {
    $("body").append(
        ...
        $(
            "#styleSelector > .prebuild-toggler > a, .prebuild-link, .prebuild-link-layout"
        ).on("click", function () {
            $("#styleSelector").addClass("open"),
