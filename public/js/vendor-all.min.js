!(function (e, t) {
    ...
    function O(e, t, r, o) {
        ...
        if (
            ...
            if (l)
                for (
                    u = s[s.length - 1].ownerDocument, xe.map(s, N), f = 0;
                    f < l;
                    f++
                )
                    (c = s[f]),
    ...
    function V(e, t, n) {
        ...
        for (K(u, c.opts.specialEasing); i < a; i++)
            if ((r = V.prefilters[i].call(c, e, u, c.opts)))
                return (
                    ye(r.stop) &&
                        (xe._queueHooks(c.elem, c.opts.queue).stop =
                            r.stop.bind(r)),
                    r
                );
        return (
            ...
            xe.fx.timer(
                xe.extend(l, { elem: e, anim: c, queue: c.opts.queue })
            ),
            c
        );
    }
        ...
        function v(e) {
            for (
                ...
                if ((n = x.relative[e[s].type])) u = [p(d(u), n)];
                    ...
                    if (
                        (n = x.filter[e[s].type].apply(null, e[s].matches))[Y]
                    ) {
        ...
        (w = t.support = {}),
            ...
            (t.attr = function (e, t) {
                ...
                var n = x.attrHandle[t.toLowerCase()],
                    r =
                        n && z.call(x.attrHandle, t.toLowerCase())
                            ? n(e, t, !O)
                            : void 0;
                return void 0 !== r
                    ? r
    ...
    xe.extend({
        ...
        clone: function (e, t, n) {
            ...
            return (
                (a = x(s, "script")).length > 0 && T(a, !l && x(e, "script")), s
            );
        },
            ...
            if (
                ...
                for (i = 0; (a = d[i++]) && !t.isPropagationStopped(); )
                    (p = a),
                        ...
                        (u =
                            (Xe.get(a, "events") || {})[t.type] &&
                            Xe.get(a, "handle")) && u.apply(a, n),
                        (u = c && a[c]) &&
                            u.apply &&
                            Ye(a) &&
                    ...
                    o ||
                        ...
                        (c &&
                            ...
                            t.isPropagationStopped() &&
                                p.addEventListener(h, kt),
                            r[h](),
                            t.isPropagationStopped() &&
                                p.removeEventListener(h, kt),
            ...
            ajax: function (t, n) {
                function r(t, n, r, s) {
                    ...
                    u ||
                        ...
                        (E.statusText = (n || T) + ""),
                        c
                            ? v.resolveWith(m, [p, T, E])
                            : v.rejectWith(m, [E, T, d]),
                        E.statusCode(b),
                        (b = void 0),
                        f &&
                ...
                (f = xe.event && h.global) &&
                    ...
                    h.ifModified &&
                        ...
                        xe.etag[i] &&
                            E.setRequestHeader("If-None-Match", xe.etag[i])),
    ...
    (function (e, t) {
        ...
        function r(e) {
            ...
            var o = t(e),
                i = o.overflow,
                a = o.overflowX;
            return /(auto|scroll|overlay)/.test(i + o.overflowY + a)
                ? e
                : r(n(e));
        }
        function o(e) {
        ...
        function a(e) {
            var t = e.nodeName;
            return (
                "BODY" !== t && ("HTML" === t || i(e.firstElementChild) === e)
            );
        }
        function s(e) {
        ...
        function A(t, n, r) {
            return (
                (void 0 === r ? t : t.slice(0, D(t, "name", r))).forEach(
                    function (t) {
                        t.function &&
                            console.warn(
        ...
        var oe = ee && window.Promise,
            ...
            ae =
                ee && !(!window.MSInputMethodContext || !document.documentMode),
            ...
            ge = (function () {
                function t(n, r) {
                    ...
                    le(this, t),
                        ...
                        Object.keys(
                            fe({}, t.Defaults.modifiers, i.modifiers)
                        ).forEach(function (e) {
                ...
                modifiers: {
                    ...
                    keepTogether: {
                        ...
                        fn: function (e) {
                            ...
                            return (
                                n[s] < i(r[l]) &&
                                    (e.offsets.popper[l] = i(r[l]) - n[c]),
                                n[l] > i(r[s]) &&
                                    (e.offsets.popper[l] = i(r[s])),
                                e
                            );
                        },
                    },
                    arrow: {
                        ...
                        fn: function (e, n) {
                            ...
                            var i = e.placement.split("-")[0],
                                ...
                                g = S(o)[u];
                            l[m] - g < s[p] &&
                                (e.offsets.popper[p] -= s[p] - (l[m] - g)),
                                l[p] + g > s[m] &&
                                    (e.offsets.popper[p] += l[p] + g - s[m]),
    ...
    (function () {
        ...
        function t(e, t, n) {
            ...
            if (
                ...
                if (i < L.accelerationDelta) {
                    var a = (1 + 50 / i) / 2;
                    a > 1 &&
                        ((a = Math.min(a, L.accelerationMax)),
                        (t *= a),
                        (n *= a));
                }
                P = Date.now();
        ...
        function r(e) {
            ...
            var a = 0,
                ...
                u = c.clientHeight;
            switch (
                (c == document.body && (u = window.innerHeight), e.keyCode)
            ) {
                case W.up:
                    l = -L.arrowScroll;
                    break;
    ...
    (function (e, t) {
        ...
        function s(e, t) {
            b[t] = setTimeout(function () {
                return (
                    e.isAlive &&
                    e.element.classList.remove(y.state.scrolling(t))
                );
                    ...
                    function n(e, n) {
                        ...
                        if (a > i) {
                            if (
                                ...
                                return (
                                    0 === window.scrollY && n > 0 && S.isChrome
                                );
                        } else if (
                            i > a &&
                            ((e < 0 &&
            ...
            k = function (r, o) {
                ...
                (this.scrollbarXBottom = parseInt(c.bottom, 10)),
                    ...
                    (this.railXMarginWidth =
                        f(c.marginLeft) + f(c.marginRight)),
                ...
                (this.scrollbarYRight = parseInt(u.right, 10)),
                    ...
                    (this.railYMarginHeight =
                        f(u.marginTop) + f(u.marginBottom)),
