    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function(callingElement) {
            ...
            if (!newValue && ((settings.allowNulls) && settings.allowNulls != true)) {
                ...
                if (settings.onValidate(cell, row, newValue, cellName)) {
                    _update(newValue);
                } else {
                    _addValidationCss();
                }
