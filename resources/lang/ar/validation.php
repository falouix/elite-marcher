...
return [
    ...
    |
    */
    'v_title'=>'يرجي التحقق من الأخظاء التالية',
    ...
    */
    ...
    'attributes' => [
        ...
        'qin'                  => '"رقم التعريف القطري"',
        'full_name'                  => '"الإسم"',
        'email'                  => '"البريد الإلكتروني"',
        'clients_id'                  => '"إسم العميل"',
        'payement_amount'                  => '"المبلغ المدفوع"',
        'payement_libele'                  => '"اسم الدفعة"',
        'file'                  => '"المستند"',
        'poa_title'                  => '"المسمى على التوكيل"',
