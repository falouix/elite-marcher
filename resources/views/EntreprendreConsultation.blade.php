...
@section('content')
@section('title')
<h5>التعهد واسناد الصفقة استشارة عدد : CO01</h5>
@endsection
                            ...
                            <div class="card-header">
                                ...
                                <div class="row"><!--style="width: 30px"-->
                                    <div class="col-auto mb-3"><br>
                                        ...
                                        <h6>تاريخ اسناد الصفقة :</h6><input  type='text' value="20/05/2021" class="form-control" style='width:380px;'>
                                        <h6>موقع الاشهار:</h6>
                                        <select class="form-control" style='width:380px;'>
                                    ...
                                    <div class="col mb-3"><br>
                                       <h6> المشروع :</h6><input  class="form-control" value="اقتناء حواسيب وطابعات" type='text' style='width:380px;'>
                                        <h6>الإطار :</h6>
                                        <select class="form-control"style='width:380px;' >
                                        ...
                                        <h6>تاريخ اشهار الإسناد:</h6><input  type='text' value="21/05/2021" class="form-control" style='width:380px;'>
