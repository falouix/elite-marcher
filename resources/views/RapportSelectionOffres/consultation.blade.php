@extends('layouts.app')
@section('title')
<h5>المصادقة على تقرير فرز العروض استشارة عدد : CO01</h5>
@endsection
@section('content')
                                ...
                                <div class="row"><!--style="width: 30px"-->
                                    <div class="col-auto mb-3"><br>
                                        ...
                                        <select name="" id="" class="form-control" style='width:380px;'>
                                            <option value="" selected>محلية</option>
                                            <option value="" >جهوية</option>
                                            <option value="">وطنية</option>
                                        </select>
                                        <h6>جلسة عدد :</h6> <input type="text" class="form-control" style='width:380px;' value="2021/05">
                                    ...
                                    <div class="col mb-3"><br>
                                        ...
                                        <h6>التاريخ  :</h6> <input type="text" class="form-control" style='width:380px;' value="20/05/2021">
                                    </div>
    ...
    @section('srcipt-js')
        <script>
            $(document).ready(function() {
                ...
                var table=[
                    ['15/05/2021','10:00','','شركة TECHNO','','6500','<select><option value="" selected >الموافقة</option><option value="" >الرفض</option></select>','<select><option value="" selected >الموافقة</option><option value="" >الرفض</option></select>',''],
                    ['17/05/2021','08:00','','SIBE','','7000','<select><option value="" selected >الموافقة</option><option value="" >الرفض</option></select>','',''],
                    ['18/05/2021','09:00','','H2i','','8500','<select><option value="" selected >الموافقة</option><option value="" >الرفض</option></select>','','']
                   ];
