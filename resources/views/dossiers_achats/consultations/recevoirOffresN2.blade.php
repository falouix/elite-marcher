            ...
            <div class="card-header">
             ...
             <div class="col-md-12"><br>
                <div class="row">
                                            <div class="col-md-6">
                                                <label>الموضوع :</label>
                                                <input class="mb-3 form-control " type="text" placeholder='اقتناء حواسيب وطابعات'>
                                                <label>الإطار :</label>
                                                ...
                                                <input class="mb-3 form-control " type="text" placeholder='17/05/2021'>
                                                <label>الساعة :</label>
                                                <input class="mb-3 form-control " type="text" placeholder='08:00'>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="mb-3 form-control " type="text" placeholder='01254'>
                                                <label>تاريخ التسجيل :</label>
                                                <input class="mb-3 form-control " type="text" placeholder='18/05/2021'>
                                                <label>الملاحظات :</label>
                                                <textarea  class="mb-3 form-control " type="text" placeholder=''></textarea> 
