        ...
        <div class="main-chat-cont scroll-div">
            <div class="main-friend-chat">
                ...
                <div class="media chat-messages">
                    ...
                    <a class="media-right photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="{{ asset('/images/user/avatar-1.jpg') }}" alt="Generic placeholder image"></a>
                </div>
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="{{ asset('/images/user/avatar-2.jpg') }}" alt="Generic placeholder image"></a>
                    <div class="media-body chat-menu-content">
