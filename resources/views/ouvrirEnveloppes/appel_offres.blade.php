@extends('layouts.app')
@section('title')
<h5>جلسات فتح الظروف طلب عروض عدد : AO001</h5>
@endsection
@section('content')
    ...
    @section('srcipt-js')
        <script>
            $(document).ready(function() {
                ...
                var table=[
                    ['2021/04','03/04/2021','<select><option value="">فنية</option><option value="">مالية</option><option value="" selected>فنية ومالية</option> </select>','3','','خطا في مدة الضمات','','<a class="btn btn-success feather icon-edit" href="{{route('appelOffresOuvertureEnveloppesN04')}}" role="button">تحيين</a><a class="btn btn-danger feather icon-trash-2" role="button">حذف</a>']
                   ];
