                        ...
                        border: 2px solid;">
                            <tbody>
                                <tr style="font-size: 1.2em;">
                                    ...
                                    <td rowspan="2">آجال<br>الإنجاز(1)</td>
                                    <td rowspan="2">طريقة<br>الإبرام(2)</td>
                                    <td rowspan="2">الإجراءات(3)</td>
                                    <td rowspan="2">مصدر<br>التمويل(4)</td>
                                    <td colspan="9">التاريخ التقديري(5)</td>
                                ...
                                <tr style="font-size: 1.2em;">
                                    ...
                                    <td>لتعهد<br>لجنة الشراءات<br>بالملف(6)</td>
