@extends('layouts.app')
@section('title')
<h5>وصول العروض طلب عروض عدد : AO001</h5>
@endsection
@section('content')
    ...
    @section('srcipt-js')
        <script>
            $(document).ready(function() {
                ...
                var table=[
                    ['02/04/2021','10:00','','01112','02/04/2021','<a class="btn btn-success feather icon-edit" href="{{route('appelOffresRecevoirOffresN1')}}" role="button">تحيين</a><a class="btn btn-danger feather icon-trash-2" role="button">حذف</a>'],
                    ['02/04/2021','09:00','','01130','02/04/2021','<a class="btn btn-success feather icon-edit" href="" role="button">تحيين</a><a class="btn btn-danger feather icon-trash-2" role="button">حذف</a>'],
                    ['03/04/2021','08:00','','01138','03/04/2021','<a class="btn btn-success feather icon-edit" href="" role="button">تحيين</a><a class="btn btn-danger feather icon-trash-2" role="button">حذف</a>']
                    ];
